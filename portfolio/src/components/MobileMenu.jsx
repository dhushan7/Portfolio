...
export const MobileMenu = ({menuOpen, setMenuOpen}) => {
    ...
    return (
        <div className={`fixed top-0 left-0 w-full bg-[rgba(10,10,10,0.8)] backdrop-blur z-40 flex flex-col items-center justify-center transition-opacity duration-500
